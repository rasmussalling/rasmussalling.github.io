...
import{_ as X}from"../chunks/C1FmrZbK.js";import{n as me,a as v,t as M,c as _e}from"../chunks/oLf7OQaa.js";import{an as ge,av as he,aI as ve,t as S,B as be,ac as _,Y as D,b as P,u as xe,f as ee,ae as ye,s as h,J as i,c as w,C as we,i as e,g as Ae,$ as Oe,r as A,L as te}from"../chunks/CiJ59dfD.js";import{d as ke,h as Ie,s as W}from"../chunks/xcIJNa73.js";import{i as B}from"../chunks/NeijCObD.js";import{a as Ee,e as Me,i as Ce,b as Te}from"../chunks/BiBmY_hh.js";import{N as De,i as Pe,s as Se}from"../chunks/C-PrEofT.js";import{E as Le}from"../chunks/BzslgVdI.js";import{r as Re}from"../chunks/DaLohAwT.js";const $e=[];function Fe(t,s=!1){return L(t,new Map,"",$e)}function L(t,s,d,c,a=null){if(typeof t=="object"&&t!==null){var g=s.get(t);if(g!==void 0)return g;if(t instanceof Map)return new Map(t);if(t instanceof Set)return new Set(t);if(ge(t)){var l=Array(t.length);s.set(t,l),a!==null&&s.set(a,l);for(var f=0;f<t.length;f+=1){var m=t[f];f in t&&(l[f]=L(m,s,d,c))}return l}if(he(t)===ve){l={},s.set(t,l),a!==null&&s.set(a,l);for(var O in t)l[O]=L(t[O],s,d,c);return l}if(t instanceof Date)return structuredClone(t);if(typeof t.toJSON=="function")return L(t.toJSON(),s,d,c,t)}if(t instanceof EventTarget)return t;try{return structuredClone(t)}catch{return t}}const Ve=`// Algorithm: Repeated addition
/*
